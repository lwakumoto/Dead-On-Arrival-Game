...
weapons[weapon.BEOWULF][? "fire_delay"] = 0.4
...
weapons[weapon.TERMINATOR][? "reload_type"] = 1
...
weapons[weapon.M40][? "reload_time"] = 1.0
...
calibers[caliberType._r45][? "damage"] = 13
...
calibers[caliberType._rbeowulf][? "cost_per_shot"] = 25
...
calibers[caliberType._r308][? "penetration"] = 5
calibers[caliberType._r308][? "speed"] = 50
calibers[caliberType._r308][? "number_of_shot"] = 1
calibers[caliberType._r308][? "cost_per_shot"] = 25
#endregion
