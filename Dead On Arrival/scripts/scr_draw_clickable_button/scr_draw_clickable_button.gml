...
function scr_draw_clickable_button(xx, yy, string, font, horizontal_padding, vertical_padding, onClick = noone){
	...
	if (point_in_rectangle(device_mouse_x_to_gui(0),device_mouse_y_to_gui(0),xx - button_width/2,yy,
	xx + button_width/2, yy + text_height + vertical_padding * 2)){
	...
	draw_text_transformed(xx + horizontal_padding - button_width/2 ,yy + vertical_padding, string, text_scale, text_scale, 0)
